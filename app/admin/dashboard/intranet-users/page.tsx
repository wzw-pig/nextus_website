...
export default async function AdminIntranetUsersPage({ searchParams }: Props) {
  ...
  return (
    <>
      <section className="section">
        <div className="container">
          <div className="section-header">
            <div>
              <h2 style={{ fontSize: "1.5rem", marginBottom: "0.5rem" }}>内网账号与权限管理</h2>
      ...
      <section className="section">
        <div className="container">
          <h2 style={{ fontSize: "1.3rem", marginBottom: "1rem" }}>创建内网账号</h2>
      ...
      <section className="section">
        <div className="container">
          <h2 style={{ fontSize: "1.3rem", marginBottom: "1rem" }}>账号列表</h2>
          ...
          <h3 style={{ marginTop: "1.5rem", fontSize: "1.1rem" }}>批量编辑（底部统一保存）</h3>
