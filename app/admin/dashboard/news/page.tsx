...
export default async function AdminNewsPage({ searchParams }: Props) {
  ...
  return (
    <>
      <section className="section">
        <div className="container">
          <div className="section-header">
            <div>
              <h2 style={{ fontSize: "1.5rem", marginBottom: "0.5rem" }}>新闻发布与管理</h2>
      ...
      <section className="section">
        <div className="container">
          <h2 style={{ fontSize: "1.3rem", marginBottom: "1rem" }}>发布新闻</h2>
          <AsyncSubmitForm
      ...
      <section className="section">
        <div className="container">
          <h2 style={{ fontSize: "1.3rem", marginBottom: "1rem" }}>新闻列表</h2>
